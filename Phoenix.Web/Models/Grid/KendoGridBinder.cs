...
{
    public class KendoGridBinder : IModelBinder
    {
        ...
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            var hldValue = GetQueryStringValue("networkObjectId");
            var networkObjectId = hldValue == "" || hldValue == null ? 0 : Convert.ToInt32(hldValue);
        ...
        protected IEnumerable<SortObject> GetSortObjects(IEnumerable<string> sortKeys)
        {
        ...
        protected FilterObjectWrapper GetFilterObjects(IList<string> filterKeys, string filterLogic)
        {
        ...
        protected IEnumerable<int> GetIndexArr(IEnumerable<string> fieldKeys)
        {
        ...
        protected IEnumerable<string> GetRequestKeys()
        {
            if (_request.HttpMethod.ToUpper() == "POST")
